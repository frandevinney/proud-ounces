...
class PumpCoachingAccordion extends HTMLElement {
  constructor() {
    super();
...
if ('customElements' in window) {
  customElements.define('pump-coaching-accordion', PumpCoachingAccordion);
}

export default PumpCoachingAccordion;
